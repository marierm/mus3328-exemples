...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1239.0, 232.5, 129.0, 26.0 ],
					"style" : "",
					"text" : "scale -180 180 2. 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1124.0, 440.807495, 116.0, 26.0 ],
					"style" : "",
					"text" : "scale -90 90 50 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 282.0, 129.0, 26.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1088.0, 363.0, 116.0, 26.0 ],
					"style" : "",
					"text" : "scale -90 90 20 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1225.0, 329.0, 116.0, 26.0 ],
					"style" : "",
					"text" : "scale -90 90 0.5 2.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1004.5, 239.5, 123.0, 26.0 ],
					"style" : "",
					"text" : "scale -180 180 20 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1041.0, 191.0, 217.0, 20.0 ],
					"style" : "",
					"text" : "Yaw, Pitch and Roll from sensor stick"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1012.0, 99.0, 79.0, 26.0 ],
					"style" : "",
					"text" : "unpack 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1308.0, 152.0, 80.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1150.0, 152.0, 80.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1012.0, 152.0, 80.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1012.0, 61.0, 64.0, 26.0 ],
					"style" : "",
					"text" : "route /imu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1012.0, 20.5, 121.0, 26.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 865.0, 471.0, 72.0, 26.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 763.0, 373.0, 133.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 776.0, 396.0, 114.0, 17.0 ],
					"preset_data" : [ 						{
							"number" : 1,
...
, 						{
							"number" : 8,
							"data" : [ 5, "obj-84", "flonum", "float", 0.3, 5, "obj-83", "flonum", "float", 1.0, 5, "obj-26", "flonum", "float", 1.0, 5, "obj-88", "flonum", "float", 4000.0, 5, "obj-89", "flonum", "float", 4000.0, 5, "obj-82", "flonum", "float", 0.3, 5, "obj-23", "flonum", "float", 1.0, 5, "obj-87", "flonum", "float", 4000.0, 5, "obj-90", "flonum", "float", 4000.0 ]
						}
, 						{
							"number" : 9,
							"data" : [ 5, "obj-84", "flonum", "float", 0.3, 5, "obj-83", "flonum", "float", 1.115556, 5, "obj-26", "flonum", "float", 1.433333, 5, "obj-88", "flonum", "float", 1250.0, 5, "obj-89", "flonum", "float", 80.0, 5, "obj-82", "flonum", "float", 1.115556, 5, "obj-23", "flonum", "float", 1.433333, 5, "obj-87", "flonum", "float", 50.0, 5, "obj-90", "flonum", "float", 38.0 ]
						}
 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 39.0, 50.0, 22.0 ],
					"style" : "messageGold",
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 140.0, 351.0, 34.0, 57.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 764.700012, 273.0, 787.5, 273.0 ],
					"source" : [ "obj-12", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 556.5, 78.0, 587.5, 78.0 ],
					"source" : [ "obj-142", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 874.5, 466.0, 761.0, 466.0, 761.0, 433.0, 785.5, 433.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/mus3328/exercices/capteurs/IMU/granular",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
