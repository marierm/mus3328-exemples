...
void draw() {
  ...
  OscMessage myMessage = new OscMessage("/imu");
  myMessage.add((int) (yaw - yawOffset));
  myMessage.add((int) -(pitch - pitchOffset));
  myMessage.add((int) (roll - rollOffset));
